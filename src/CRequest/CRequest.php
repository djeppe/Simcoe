...
class CRequest {
     ...
     * 
     * Calculate the base_url of the installation. Store all useful details in $this.
     * 
	...
	public function Init($baseUrl = null) {
        ...
        // Check if this looks lika a querystring approach link
